...
#define DEFINE_HANDLER(opcode, status, processing, packetclass, handler) \
    ...
    DEFINE_HANDLER(CMSG_COMPLETE_CINEMATIC,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Character::CompleteCinematic, &WorldSession::HandleCompleteCinematic);
    ...
    DEFINE_HANDLER(CMSG_GUILD_BANKER_ACTIVATE,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Guild::GuildBankActivate, &WorldSession::HandleGuildBankerActivate);
    ...
    DEFINE_HANDLER(CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY,                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Guild::GuildBankRemainingWithdrawMoneyQuery, &WorldSession::HandleGuildBankMoneyWithdrawn);
    ...
    DEFINE_HANDLER(CMSG_GUILD_DEL_RANK,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Guild::GuildDeleteRank, &WorldSession::HandleGuildDelRank);
    DEFINE_HANDLER(CMSG_GUILD_DEMOTE,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Guild::GuildDemoteMember, &WorldSession::HandleGuildDemoteMember);
    ...
    DEFINE_HANDLER(CMSG_GUILD_INFO_TEXT,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Guild::GuildUpdateInfoText, &WorldSession::HandleGuildChangeInfoText);
    DEFINE_HANDLER(CMSG_GUILD_INVITE,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Guild::GuildInviteByName, &WorldSession::HandleGuildInviteOpcode);
    ...
    DEFINE_HANDLER(CMSG_GUILD_MOTD,                                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Guild::GuildUpdateMotdText, &WorldSession::HandleGuildUpdateMotdText);
    ...
    DEFINE_HANDLER(CMSG_GUILD_PERMISSIONS,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Guild::GuildPermissionsQuery, &WorldSession::HandleGuildPermissions);
    DEFINE_HANDLER(CMSG_GUILD_PROMOTE,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Guild::GuildPromoteMember, &WorldSession::HandleGuildPromoteMember);
    ...
    DEFINE_HANDLER(CMSG_GUILD_ROSTER,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Guild::GuildGetRoster, &WorldSession::HandleGuildGetRoster);
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_LOOT_ITEM,                               STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleAutostoreLootItemOpcode   );
    ...
    DEFINE_HANDLER(CMSG_OPENING_CINEMATIC,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Character::OpeningCinematic, &WorldSession::HandleOpeningCinematic);
    ...
    DEFINE_HANDLER(CMSG_QUERY_GUILD_REWARDS,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      WorldPackets::Guild::RequestGuildRewardsList, &WorldSession::HandleRequestGuildRewardsList);
